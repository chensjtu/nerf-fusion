...
def integrate(
    ...
    return weight_vol, tsdf_vol, depth_mask,pixel_xyz_world
...
class TSDFVolumeTorch:
    ...
    def __init__(self, voxel_dim, origin, voxel_size, margin=3):
        ...
        self._world_c = self._vol_origin + (self._voxel_size * self._vox_coords) # N, 3
    ...
    def integrate(self, depth_im, cam_intr, cam_pose, obs_weight):
        ...
        im_h, im_w = depth_im.shape
        weight_vol, tsdf_vol, depth_mask, pixel_xyz_world = self._integrate_func(
            depth_im,
            cam_intr,
            cam_pose,
            obs_weight,
